package com.application.innova;
...
public class InnovaTestContainer extends TestContainer {

    public InnovaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/application/innova/app.properties",
    ...
    public static class Common extends InnovaTestContainer {

        public static final InnovaTestContainer.Common INSTANCE = new InnovaTestContainer.Common();
